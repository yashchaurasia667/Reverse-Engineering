...
class BSimOverviewRowObject(java.lang.Object):
    ...
    def __init__(self, result: ghidra.features.bsim.query.protocol.SimilarityVectorResult, ad: ghidra.program.model.address.Address, vectorFactory: generic.lsh.vector.LSHVectorFactory):
        ...
